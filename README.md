...
|-----------|------|---------|-------------|
| `bulk` | `Atoms` \| `None` | Required unless using a provided slab | ASE Atoms object representing the bulk structure; set to `None` when `opt_bulk=False` and supplying `surface` |
