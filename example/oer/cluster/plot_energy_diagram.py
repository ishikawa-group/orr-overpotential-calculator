#!/usr/bin/env python3
"""Build OER free-energy diagrams from completed cluster runs."""

from pathlib import Path

from orr_overpotential_calculator.surface.oer import (
    generate_result_csv,
...
def main() -> None:
    ...
    csv_path = result_dir / "oer_results_nanoparticles.csv"
    csv_file = generate_result_csv(materials_data=materials_data, output_csv=str(csv_path), verbose=True)
    if not csv_file:
        raise SystemExit("Failed to create OER CSV summary")
