...
#$ -l h_rt=24:00:00
#$ -N RPBE_ORR
#$ -o /gs/fs/tga-ishikawalab/wakamiya/orr_overpotential_calculator/result/log/RPBE_output.log
#$ -e /gs/fs/tga-ishikawalab/wakamiya/orr_overpotential_calculator/result/log/RPBE_error.log
...
# Run python script
python3 /gs/fs/tga-ishikawalab/wakamiya/orr_overpotential_calculator/scripts/run_test.py