...
def my_calculator(
    ...
    Args:
        atoms: ASE atoms object
        kind: "gas" / "slab" / "bulk"
        calculator: "vasp" / "mace" / "mace-d3" / "orb-v3" / "7net" /
            "uma-omat" / "uma-oc20" / "uma-oc22" / "uma-oc25" / "qe" - calculator type
    ...
    if calculator == "vasp":
        ...
        raise ValueError(
            "calculator must be 'vasp', 'mace', 'mace-d3', 'mace-mh', "
            "'mace-mh-d3', 'mace-mh-oc20', 'mace-mh-oc20-d3', 'orb-v3', '7net', "
